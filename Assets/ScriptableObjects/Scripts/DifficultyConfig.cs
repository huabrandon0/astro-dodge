...
namespace AsteroidRage
{
    ...
    public class DifficultyConfig : ScriptableObject
    {
        ...
        public float StartDiamondSpawnPercent = 0.01f;
        public int DiamondSpawnPercentAddInterval = 10;
